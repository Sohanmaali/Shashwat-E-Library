    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container">
        ...
        <div class="dropdown d-none d-lg-block">
            <a href="../myprofile/subscription2.html" id="review" >Get Premium</a>
        </div>
     <!-- ------------------------- -->
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto w-100">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                      <a class="dropdown-item" href="catgory.html" >Novel</a>
                      <a class="dropdown-item" href="catgory.html" >Science fiction</a>
                      <a class="dropdown-item" href="catgory.html" >Mystery</a>
                      <a class="dropdown-item" href="catgory.html" >Thriller</a>
                      <a class="dropdown-item" href="catgory.html" >Adventure</a>
                      <a class="dropdown-item" href="catgory.html" >Self-help</a>
                      <a class="dropdown-item" href="catgory.html" >Horror</a>
                      <a class="dropdown-item" href="catgory.html" >Text-Books</a>
                        <!-- call servlet for logout user -->
                    </div>
                </li>
                   ...
                   <li class="nav-item dropdown">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="audiobook.html"><i class="fa fa-headphones"></i> Audio Books</a>
                  </li>
